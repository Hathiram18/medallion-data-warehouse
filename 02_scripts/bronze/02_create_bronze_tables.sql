...
===============================================================================
Purpose:
    Creates all raw ingestion (Bronze) tables in the bronze schema.
    Safe to rerun using DROP TABLE IF EXISTS.
===============================================================================
*/
...
COMMENT ON SCHEMA bronze IS 'Raw ingestion layer (Bronze)';
